...
import application.contracts.dataobjects.carparts.AddTransmissionRequest;
import domain.valueObjects.ModelName;
import domain.valueObjects.Price;
import org.mapstruct.Mapper;
import org.mapstruct.Mapping;
import org.mapstruct.Named;
import presentation.entryobjects.carparts.AddTransmissionDto;

import java.util.List;

@Mapper(componentModel = "spring")
public interface IAddTransmissionMapper {
    ...
    AddTransmissionRequest toRequest(AddTransmissionDto source);
